        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className='mt-5 order-1 md:order-none'>
              ...
              <p className='text-md mt-5 text-gray-500 font-light'>{toPersianDigits(moment(data.createdAt).locale('fa').fromNow())}</p>
              <div className='flex items-center justify-between mt-4 border-b py-3'>
                <h3 className="font-light">قیمت : </h3>
              ...
              <div className='flex items-center justify-between border-b py-3'>
                <h3 className="font-light">مایل به معاوضه : </h3>
                <p className='text-gray-500'>
              ...
              <div className='whitespace-pre-wrap text-[15px] leading-8 font-light' dangerouslySetInnerHTML={{ __html: data.description }} />
            </div>
            <div>
              <div className='relative overflow-hidden rounded-md w-full h-[26rem] bg-gray-300 aspect-w-10 aspect-h-9'>
                <Image fill src={`${process.env.NEXT_PUBLIC_BASE_API_URL}/images/${data.image.filename}`} className="absolute w-full h-full object-center" alt="test" />
              </div>
