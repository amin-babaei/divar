...
const Support = () => {
    return (
        <section>
            <h3 className='text-center mt-10 text-lg font-thin text-gray-400'>چطور می‌توانیم کمکتان کنیم؟</h3>
            ...
            <div className="container mx-auto px-3 mt-10">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-y-10 mb-5">
                    <div className='flex flex-col items-center'>
                        <Image src={signup} alt="" className='w-16 h-16'/>
                    ...
                    <div className='flex flex-col items-center'>
                        <Image src={management} alt="" className='w-16 h-16'/>
                    ...
                    <div className='flex flex-col items-center'>
                        <Image src={check} alt="" className='w-16 h-16'/>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-y-10 mt-10 mb-5">
                    <div className='flex flex-col items-center'>
                        <Image src={phone} alt="" className='w-16 h-16'/>
                    ...
                    <div className='flex flex-col items-center'>
                        <Image src={warning} alt="" className='w-16 h-16'/>
                        <h3 className='my-3 text-gray-500'>تماس با واحد گزارش تخلف</h3>
                        <button className='text-red-700 text-xs p-2 px-3 font-semibold rounded border border-red-700 duration-300 hover:bg-red-50'>تماس تلفنی</button> 
                    </div>
                    <div className='flex flex-col items-center'>
                        <Image src={envelope} alt="" className='w-16 h-16'/>
