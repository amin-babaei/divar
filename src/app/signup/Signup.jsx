...
const Signup = () => {
    ...
    return (
        <form className={`flex flex-col gap-4 px-3 md:w-1/3 md:mx-auto mt-8 ${iranFont.variable} font-sans font-light`} onSubmit={formik.handleSubmit}>
            ...
            <Link href='/signin' className='text-sm cursor-pointer w-fit mb-3 font-medium'>
