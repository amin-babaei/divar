...
import { useAdsVerify, useMutationVerifyAd } from "./hooks/useVerifyAds"
...
const VerifyAds = () => {
    ...
    const { data, isLoading, isError, refetch } = useAdsVerify(currentPage)
    const mutation = useMutationVerifyAd()
